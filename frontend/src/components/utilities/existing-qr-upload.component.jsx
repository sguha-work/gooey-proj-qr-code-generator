    ...
    fetch(`${SERVER_URL}/image/upload`, {
      ...
      .then(async (response) => {
        if (response.ok) {
          ...
          Subject_ExistingQRFileUploaded$.next(output.data);// sending the data for image parsing
          return output;
        } else {
          ...
          <div className="w-full p-10 rounded-xl border-4 border-gray-300 border-dashed text-center">
            ...
            <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
              <span className="font-semibold">
                {selectedFile ? "" : "Drag and drop an image of QR or Browse"}
              </span>
            </p>
...
export default ExistingQRUploadComponent