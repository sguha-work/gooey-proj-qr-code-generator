    ...
    const submit = () => {
        ...
        const payload = {
            ...
            "qr_code_vcard": {
                ...
                "email": (emailDOM&&emailDOM.current.value.trim() != "") ? emailDOM.current.value.trim() : "",
                "gender": (genderDOM&&genderDOM.current.value.trim() != "") ? genderDOM.current.value.trim() : "",
                "address": (addressDOM&&addressDOM.current.value.trim() != "") ? addressDOM.current.value.trim() : "",
                "language": null,
                "logo_url": null,
                "timezone": null,
                "job_title": null,
                "photo_url": (photoURL&&photoURL.current.value.trim() != "") ? photoURL.current.value.trim() : "",
                "given_name": null,
                "family_name": null,
                "format_name": (nameDOM&&nameDOM.current.value.trim() != "") ? nameDOM.current.value.trim() : "",
                "birthday_day": null,
                "calendar_url": null,
                "middle_names": null,
                "organization": null,
